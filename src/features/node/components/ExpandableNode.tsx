...
export function ExpandableNode({ id, data }: ExpandableNodeProps) {
  ...
  const getNodeStyle = () => {
    const baseStyle =
      "px-4 py-2 shadow-md rounded-lg border text-center cursor-pointer transition-all duration-200";
